...
let
  user      = "admin";
  password  = "password";
  hostname  = "69290d4ba69fd0ee6da2aa0e";
  homeDir   = "/home/${user}";
  ...
  hardware = {
    ...
    deviceTree = {
      ...
      overlays = [
        {
          name = "spi1-3cs";
          dtboFile = "${pkgs.raspberrypi-dt-overlays}/overlays/spi1-3cs.dtbo";
        }
        {
          name = "can0";
          dtboFile = "${pkgs.raspberrypi-dt-overlays}/overlays/mcp251xfd.dtbo";
          params = {
            "spi0-0" = "";
            interrupt = "25";  # GPIO25
            # oscillator = "40000000"; # optional
          };
        }
        {
          name = "can1";
